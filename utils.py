...
def classify_query(query: str) -> str:
    ...
    stock_keywords = [
        "stock", "market", "share", "nasdaq", "dow jones", "s&p", "finance", 
        "investment", "trading", "equity", "portfolio", "earnings", "dividend"
    ]
    sentiment_keywords = [
        "sentiment", "news", "social media", "opinion", "trends", "buzz", 
...
def trim_text_to_token_limit(text: str, max_tokens: int = 5900, encoding_name: str = "cl100k_base") -> str:
